...
Szablon scenariusza: Szacowanie czasu przyjazdu.
	Zakładając chcę się dostać z <z_miasto> do <do_miasto>
	I następny pociąg odjeżdża o <z_godzina> na linii <linia>
	Gdy zapytam o godzinę przyjazdu
	Wtedy powinienem uzyskać następujący szacowany czas przyjazdu: <do_godzina>
	Przykłady:
		| z_miasto		|	do_miasto	|	z_godzina	|	linia		|	do_godzina	|
